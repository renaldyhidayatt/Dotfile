...
autocmd FileType typescript.tsx set syntax=typescript
autocmd FileType markdown setlocal expandtab shiftwidth=2 softtabstop=2 colorcolumn=120  conceallevel=0
